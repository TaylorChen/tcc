package com.sun.demo.tpc.bankcommon.domain;

import com.sun.demo.tpc.bankcommon.service.*;
import com.sun.demo.tpc.protocol.conf.TransactionManagerNode;
import com.sun.demo.tpc.protocol.domian.*;
import com.sun.demo.tpc.protocol.service.MessageSender;
import com.sun.demo.tpc.protocol.service.TransactionRepository;
...
public class BankingParticipant extends AbstractParticipant {
    ...
    public void afterPropertiesSet() throws Exception {
        // 如果实现了InitializingBean接口，则调用bean的afterPropertiesSet方法
        ...
        try {
            transactionTemplate.execute(new TransactionCallbackWithoutResult() {
                ...
                protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                    ...
                    getParticipantLogKeeper().recordMsg(transaction, com.sun.demo.tpc.protocol.domian.TransactionStatus.Yes);
                }
            });
            ...
            try {
                getParticipantLogKeeper().recordMsg(transaction, com.sun.demo.tpc.protocol.domian.TransactionStatus.Abort);
            } catch (Exception e2) {
    ...
    public void commit(DistributedTransaction transaction) {
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                getParticipantLogKeeper().recordMsg(transaction, com.sun.demo.tpc.protocol.domian.TransactionStatus.Commit);
